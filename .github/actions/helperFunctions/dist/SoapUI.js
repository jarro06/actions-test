...
exports.writeSettings = exports.generatePomString = void 0;
const Test_1 = require("./Test");
function generatePomString(releaseTests, workspace) {
    let count = 1;
...
exports.generatePomString = generatePomString;
function writeSettings(testCase, workspace) {
    let preSettings = `
<?xml version="1.0" encoding="UTF-8"?>
...
`;
    ...
    let settings = preSettings + settingsLine;
    (0, Test_1.writeContentToFile)(settings, `${workspace}/testcases/${testCase.pathToProjectDirectory}/${testCase.soapUiProjectName}-settings.xml`);
}
